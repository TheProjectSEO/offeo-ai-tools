...
export default function TextGenerationPage() {
  ...
  const handleGenerate = async () => {
    if (!prompt.trim()) {
      setError('Please enter a description for your text')
      return
    }
      ...
      <section className="py-12 md:py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style={{background: 'var(--accent-warm)'}}>
            ...
            <span className="text-sm font-medium" style={{color: 'var(--text-primary)'}}>AI Text Generator</span>
          </div>
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-12" style={{color: '#666666'}}>
            Generate compelling text content for any purpose. From blog posts to marketing copy, our AI text generator creates human-like content in seconds.
          </p>
        </div>
      </section>
          ...
          <div className="rounded-3xl p-8 md:p-12 shadow-xl" style={{background: 'var(--accent-warm)'}}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="relative mb-6">
                  <textarea
                    ...
                    placeholder="Write a professional email about meeting rescheduling..."
              ...
              <div>
                ...
                {/* Provider info below the text area */}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-medium tracking-tight mb-4" style={{color: 'var(--text-primary)'}}>
              Create Perfect Text Content
            </h2>
            <p className="text-lg max-w-2xl mx-auto" style={{color: '#666666'}}>
              Our AI text generator uses advanced language models to create high-quality, human-like text for any purpose. Perfect for content creators, marketers, and writers.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Smart AI Writing</h3>
              <p className="text-sm" style={{color: '#666666'}}>Advanced AI models for natural text generation</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Multiple Formats</h3>
              <p className="text-sm" style={{color: '#666666'}}>Emails, articles, social posts, and more</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Easy to Use</h3>
              <p className="text-sm" style={{color: '#666666'}}>One-click copy and paste functionality</p>
            </div>
          </div>
        </div>
      </section>
