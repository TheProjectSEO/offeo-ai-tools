...
export default function PokemonGenerationPage() {
  ...
  const handleGenerate = async () => {
    if (!prompt.trim()) {
      setError('Please enter a description for your Pokemon')
      return
    }
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to generate Pokemon')
      }
  ...
  const handleDownload = () => {
    if (generatedImage) {
      ...
      link.download = 'generated-pokemon.png'
      ...
      <section className="py-12 md:py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style={{background: 'var(--accent-warm)'}}>
            ...
            <span className="text-sm font-medium" style={{color: 'var(--text-primary)'}}>AI Pokemon Generator</span>
          </div>
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-12" style={{color: '#666666'}}>
            Create your own Pokemon creatures with AI. Design unique pocket monsters with custom abilities, types, and appearances.
          </p>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="relative mb-6">
                  <textarea
                    ...
                    placeholder="A fire-type Pokemon with dragon wings, glowing orange scales, and lightning bolt patterns, standing in a mystical forest..."
                ...
                <div className="aspect-square rounded-xl border-2 border-dashed border-gray-300 flex items-center justify-center relative overflow-hidden" style={{background: '#FFFFFF'}}>
                  {generatedImage ? (
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-gray-500">Your generated Pokemon will appear here</p>
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg max-w-2xl mx-auto" style={{color: '#666666'}}>
              Design unique Pokemon creatures with AI. Perfect for fan art, game concepts, and imaginative creature design.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Creative Design</h3>
              <p className="text-sm" style={{color: '#666666'}}>Unique Pokemon with custom abilities</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>All Types</h3>
              <p className="text-sm" style={{color: '#666666'}}>Fire, water, electric, and more types</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Game Ready</h3>
              <p className="text-sm" style={{color: '#666666'}}>High-quality creature designs</p>
            </div>
          </div>
        </div>
      </section>
