...
import { MessageSquare, Sparkles, Download, Copy } from 'lucide-react'
...
export default function DialogueGenerationPage() {
  ...
  const handleGenerate = async () => {
    if (!prompt.trim()) {
      setError('Please enter a dialogue scenario or prompt')
      return
    }
      ...
      <section className="py-12 md:py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style={{background: 'var(--accent-warm)'}}>
            ...
            <span className="text-sm font-medium" style={{color: 'var(--text-primary)'}}>AI Dialogue Generator</span>
          </div>
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-12" style={{color: '#666666'}}>
            Create realistic conversations and dialogue for your stories, scripts, and creative projects. Generate natural-sounding conversations between characters.
          </p>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="relative mb-6">
                  <textarea
                    ...
                    placeholder="Two friends arguing about whether to take a risky business opportunity..."
                ...
                <div className="min-h-96 rounded-xl border-2 border-dashed border-gray-300 flex items-start justify-start p-4 relative" style={{background: '#FFFFFF'}}>
                  {generatedDialogue ? (
                    ...
                    <div className="w-full text-center flex flex-col items-center justify-center h-full">
                      ...
                      <p className="text-gray-500">Your generated dialogue will appear here</p>
                    </div>
                  )}
                </div>
                
                {/* Provider info below the dialogue */}
                {generatedDialogue && provider && (
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg max-w-2xl mx-auto" style={{color: '#666666'}}>
              Our AI dialogue generator creates realistic conversations between characters. Perfect for screenwriters, novelists, and content creators.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Natural Speech</h3>
              <p className="text-sm" style={{color: '#666666'}}>AI-generated dialogue that sounds authentic</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Character Voice</h3>
              <p className="text-sm" style={{color: '#666666'}}>Distinct personalities and speaking styles</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Script Ready</h3>
              <p className="text-sm" style={{color: '#666666'}}>Formatted for scripts and screenplays</p>
            </div>
          </div>
        </div>
      </section>
