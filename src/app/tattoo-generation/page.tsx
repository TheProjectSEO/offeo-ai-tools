...
import { Pen, Sparkles, Download, Copy } from 'lucide-react'
...
export default function TattooGenerationPage() {
  ...
  const handleGenerate = async () => {
    if (!prompt.trim()) {
      setError('Please enter a description for your tattoo design')
      return
    }
    ...
    try {
      ...
      console.error('Error generating tattoo design:', err)
    } finally {
      ...
      <section className="py-12 md:py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style={{background: 'var(--accent-warm)'}}>
            ...
            <span className="text-sm font-medium" style={{color: 'var(--text-primary)'}}>AI Tattoo Generator</span>
          </div>
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-12" style={{color: '#666666'}}>
            Design unique tattoo concepts with AI. Create custom tattoo designs for inspiration and artistic exploration.
          </p>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="relative mb-6">
                  <textarea
                    ...
                    placeholder="A intricate black and grey dragon wrapped around a Japanese cherry blossom tree, with geometric patterns and fine line details..."
                ...
                <div className="aspect-square rounded-xl border-2 border-dashed border-gray-300 flex items-center justify-center relative overflow-hidden" style={{background: '#FFFFFF'}}>
                  {generatedImage ? (
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-gray-500">Your generated tattoo design will appear here</p>
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg max-w-2xl mx-auto" style={{color: '#666666'}}>
              Generate unique tattoo concepts and designs. Perfect for tattoo artists, enthusiasts, and anyone exploring body art ideas.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Artistic Designs</h3>
              <p className="text-sm" style={{color: '#666666'}}>Unique and creative tattoo concepts</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Multiple Styles</h3>
              <p className="text-sm" style={{color: '#666666'}}>Traditional, modern, geometric, and more</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{color: 'var(--text-primary)'}}>Reference Quality</h3>
              <p className="text-sm" style={{color: '#666666'}}>High-detail designs for artist reference</p>
            </div>
          </div>
        </div>
      </section>
